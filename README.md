...
For example,
```
swift build -Xlinker -L/usr/local/lib -Xlinker -lmysqlclient -Xcc -I/usr/local/include/
swift test -Xlinker -L/usr/local/lib -Xlinker -lmysqlclient -Xcc -I/usr/local/include/
